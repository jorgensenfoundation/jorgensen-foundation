...
function showState(id) {
  // Called both internally with a string id and by the delegated dispatcher with the
  // clicked element (read the target state from data-state in that case).
  if (id && typeof id !== 'string') id = id.dataset.state;
